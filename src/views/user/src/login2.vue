<template lang="pug">
  .phoneLogin
    ...
    .content
      ...
      .tips(@click="openTips") 《万物直供用户协议》
    transition(name="fade")
      .mask(v-if="popShow.code || popShow.tips", @click="hidePop")
    transition(name="fade")
      .agreementWrapper(v-show="popShow.tips")
        .agreementHeader 万物直供网站用户协议
          .agreementClose(@click.stop="popShow.tips=false")
        .wrapper(ref="agreementWrapper")
          .agreementContent
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        loginFlag: true,
        phoneReg: /^((13[0-9])|(14[0-9])|(15([0-9]))|(17[0-9])|(18[0-9])|(19[0-9]))\d{8}$/,
        codeFlag: true,
        W5MALLTOKEN:'',
        codeItem: [],
        code: '',
