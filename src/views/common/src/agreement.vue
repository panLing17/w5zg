<template lang="pug">
  .argreement
    transition(name="fade")
      .mask(v-show="aShow", @click.stop="aShow=false")
    transition(name="fade")
      .agreementWrapper(v-show="aShow")
        .agreementHeader 万物直供网站用户协议
          .agreementClose(@click.stop="aShow=false")
  ...
  export default {
    ...
    methods: {
      mShow () {
        this.aShow = true
        this.$nextTick(()=> {
          if (!this.agreementScroll) {
            this.agreementScroll = new BScroll(this.$refs.agreementWrapper, {
              click: true
            })
          }
        })
